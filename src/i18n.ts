    ...
    translation: {
      ...
      explore: {
        ...
        items: [
          ...
          { title: 'TPN Penthouse', size: '150 SqM', desc: '2 Bedrooms, 2 King Beds, Living Room, Kitchen, Bathtub, 5 Pax' }
        ]
      },
      roomDetail: {
        size: 'Size',
      ...
      faq: {
        ...
        items: [
          { q: 'Where is the hotel located?', a: 'We are located at 180 Bach Dang, Hai Chau Ward, Da Nang. Only 850m from Dragon Bridge, 190m to Han Market, and 3km to My Khe Beach.' },
  ...
  vi: {
    translation: {
      ...
      explore: {
        ...
        desc: 'Khám phá không gian nghỉ dưỡng đẳng cấp với các hạng phòng Suite sang trọng và cao cấp tại Khách sạn Tân Phương Nam. Khách sạn mang đến 3 lựa chọn phòng nổi bật: Premier Room, Executive Room và TPN Penthouse Room, đáp ứng mọi nhu cầu lưu trú từ công tác đến nghỉ dưỡng. Tất cả các hạng phòng đều sở hữu tầm nhìn tuyệt đẹp hướng ra sông Hàn thơ mộng, nơi du khách có thể chiêm ngưỡng vẻ đẹp lung linh của thành phố Đà Nẵng.',
        from: 'Từ',
        items: [
      ...
      faq: {
        ...
        items: [
          { q: 'Khách sạn ở vị trí nào?', a: 'Khách sạn tọa lạc tại 180 Bạch Đằng, phường Hải Châu, Đà Nẵng. Chỉ cách Cầu Rồng 850m, chợ Hàn 190m và biển Mỹ Khê 3km.' },
  ...
  ko: {
    translation: {
      ...
      faq: {
        ...
        title: '지금 알아야 할 모든 것',
        items: [
          { q: '호텔은 어디에 위치해 있나요?', a: '저희 호텔은 다낭 하이쩌우 동, 바익당 180에 위치해 있습니다. 용다리에서 850m, 한시장에서 190m, 미케 해변에서 가까운 3km 거리에 있습니다.' },
  ...
  zh: {
    translation: {
      ...
      faq: {
        ...
        title: '您现在需要了解的一切',
        items: [
          { q: '酒店位置在哪里？', a: '我们位于岘港市海洲坊白藤街 180 号。距离龙桥仅 850 米，距离汉市场 190 米，距离美溪海滩 3 公里。' },
