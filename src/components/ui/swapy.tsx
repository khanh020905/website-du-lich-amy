...
export const DragHandle = ({ className }: { className?: string }) => {
  return (
    <div
      data-swapy-handle
      className={cn(
        'absolute top-4 right-4 z-50 cursor-grab text-white/50 bg-black/40 hover:bg-black/80 hover:text-white p-2 rounded-lg transition-colors duration-300 active:cursor-grabbing',
        className
      )}
    >
      <svg
...
export const SwapySlot = ({
  ...
  return (
    <div
      className={cn(
        'data-swapy-highlighted:bg-neutral-200/50 dark:data-swapy-highlighted:bg-neutral-800/50 rounded-2xl relative',
        className
      )}
      data-swapy-slot={id}
    >
...
export const SwapyItem = ({
  ...
  return (
    <div 
      className={cn(opacityClass, 'h-full cursor-grab active:cursor-grabbing', className)} 
      data-swapy-item={id}
      data-swapy-handle
    >
      {children}
